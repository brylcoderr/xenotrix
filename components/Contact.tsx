        ...
        <div className="grid lg:grid-cols-12 gap-16 xl:gap-24 items-center">
          ...
          <div className="lg:col-span-12 xl:col-span-5 space-y-12">
            ...
            <div className="grid gap-3">
              {[
                { icon: <Mail size={18} />, label: "Secure Gateway", value: "xenotrix.connect@gmail.com", sub: "Priority Response Active", href: "mailto:xenotrix.connect@gmail.com" },
                { icon: <Clock size={18} />, label: "Quick Meeting", value: "Schedule evaluation", sub: "15min Strategy Session", href: "https://cal.com/xenotrix/15min" },
                { icon: <Phone size={18} />, label: "Direct Line", value: "+91-86796-72283", sub: "International Protocol", href: "https://wa.me/918679672283" },
