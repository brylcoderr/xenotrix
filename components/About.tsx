            ...
            <div className="grid grid-cols-2 lg:grid-cols-12 gap-4 md:gap-6 relative z-10">
              ...
              <div className="col-span-1 lg:col-span-4 flex flex-col gap-4 md:gap-6">
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="p-4 lg:p-8 rounded-3xl lg:rounded-[2.5rem] bg-linear-to-br from-brand-primary to-violet-700 shadow-2xl shadow-brand-primary/20 text-white text-center group"
                >
            ...
            >
              ...
              <div className="grid sm:grid-cols-2 gap-10 mb-16">
                <div className="relative group cursor-default">
                  <div className="flex gap-4">
                    <div className="shrink-0 w-14 h-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-brand-primary group-hover:bg-brand-primary group-hover:text-white transition-all duration-700 shadow-xl group-hover:shadow-brand-primary/20">
                      <Award size={24} />
                    </div>
                    <div>
                ...
                <div className="relative group cursor-default">
                  <div className="flex gap-4">
                    <div className="shrink-0 w-14 h-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-fuchsia-400 group-hover:bg-fuchsia-500 group-hover:text-white transition-all duration-700 shadow-xl group-hover:shadow-fuchsia-500/20">
                      <Globe size={24} />
                    </div>
                    <div>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-8 p-8 border border-white/5 rounded-[2.5rem] bg-linear-to-br from-white/3 to-transparent backdrop-blur-3xl group">
                <div className="flex -space-x-4">
                  ...
                  <div className="w-12 h-12 rounded-full border-4 border-bg-dark bg-brand-primary shadow-2xl flex items-center justify-center text-white text-[10px] font-black group-hover:scale-110 transition-transform duration-700">
                    +8
                  </div>
                </div>
