...
const PartnerLogos = () => {
  ...
  return (
    <div className="bg-bg-dark border-y border-white/5 py-12 overflow-hidden relative">
      ...
      <div className="section-container mb-8 flex flex-col items-center relative z-10">
